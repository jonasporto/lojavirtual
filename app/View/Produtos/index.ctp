<div class="produtos index">
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($produto['ParentProduto']['titulo'], array('controller' => 'produtos', 'action' => 'view', $produto['ParentProduto']['id'])); ?>
		</td>
		<td><?php echo h($produto['Produto']['lft']); ?>&nbsp;</td>
		<td><?php echo h($produto['Produto']['rght']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($produto['Usuario']['nome'], array('controller' => 'usuarios', 'action' => 'view', $produto['Usuario']['id'])); ?>
		</td>
