<div class="fotos index">
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($foto['ParentFoto']['url'], array('controller' => 'fotos', 'action' => 'view', $foto['ParentFoto']['id'])); ?>
		</td>
		<td><?php echo h($foto['Foto']['lft']); ?>&nbsp;</td>
		<td><?php echo h($foto['Foto']['rght']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($foto['Produto']['titulo'], array('controller' => 'produtos', 'action' => 'view', $foto['Produto']['id'])); ?>
		</td>
